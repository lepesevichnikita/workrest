...
public class JobController {
  ...
  public ResponseEntity<Job> create(JobDTO jobDTO, @AuthenticationPrincipal User currentUser) {
    return ResponseEntity.ok(defaultJobService.create(jobDTO, currentUser));
  }
